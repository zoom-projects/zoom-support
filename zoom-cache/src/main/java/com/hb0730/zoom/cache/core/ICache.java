...
public interface ICache {
     ...
     * @return true/false
     */
    default boolean setJson(String key, Object value, long timeout) {
        return setJson(key, value, timeout, TimeUnit.SECONDS);
    }
     ...
     * @return true/false
     */
    boolean setJson(String key, Object value, long timeout, TimeUnit unit);
     ...
     * @return true/false
     */
    boolean setObjectIfAbsent(String key, Object value, long timeout, TimeUnit unit);
     ...
     * @return value
     */
    default Optional<List<String>> getString(Collection<String> keys) {
     ...
     * @return value
     */
    default Optional<List<String>> getString(String... keys) {
        return getString(List.of(keys), true);
    }
     ...
     * @return value
     */
    Optional<List<String>> getString(Collection<String> keys, boolean normalize);
     ...
     * @return true/false
     */
    boolean setStringIfAbsent(String key, String value, long timeout, TimeUnit unit);
     ...
     * @return 值
     */
    Optional<String> hGet(String key, String item);
     ...
     * @return 值
     */
    Optional<List<String>> hmget(String key, List<String> items);
     ...
     * @return 值
     */
    default Optional<List<String>> hmget(String key, String... items) {
     ...
     * @return true/false
     */
    Optional<Map<String, String>> hValues(String key);
     ...
     * @return .
     */
    Optional<Set<String>> sGet(String key);
     ...
     * @return .
     */
    Optional<List<String>> lGet(String key, long start, long end);
     ...
     * @return .
     */
    Optional<String> lGetIndex(String key, long index);
