...
import com.hb0730.zoom.base.utils.IoUtil;
...
public class MailUtil {
    ...
    public static Session getSession(MailAccount mailAccount, boolean isSingleton) {
        ...
        return isSingleton ? Session.getDefaultInstance(mailAccount.getProperties(), authenticator) //
                : Session.getInstance(mailAccount.getProperties(), authenticator);
    }
    ...
    private static List<String> splitAddress(String addresses) {
        ...
        List<String> result;
        if (StrUtil.contains(addresses, StrPool.COMMA)) {
            result = StrUtil.splitTrim(addresses, StrPool.COMMA);
